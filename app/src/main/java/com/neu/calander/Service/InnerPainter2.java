 ...
 * @date 2019/1/3
 */
public class InnerPainter2 implements CalendarPainter {
    ...
    private Drawable has_daily_point;


    private Context mContext;


    public InnerPainter2(Context context, ICalendar calendar) {
        ...
        has_daily_point = ContextCompat.getDrawable(context,mAttrs.has_daily_bg);
    ...
    public void onDrawCurrentMonthOrWeek(Canvas canvas, RectF rectF, LocalDate localDate, List<LocalDate> checkedDateList) {
        if (checkedDateList.contains(localDate)) {
            ...
            if(!Daily_List.getsignle_instance().is_draw(localDate)) {
                ...
                drawSolar(canvas, rectF, localDate, Color.parseColor("#FF3700B3"), noAlphaColor);
                drawLunar(canvas, rectF, localDate, Color.parseColor("#FF3700B3"), noAlphaColor);
                drawPoint(canvas, rectF, localDate, mDefaultUnCheckedPoint, 255);
                drawHolidayWorkday(canvas, rectF, localDate, mAttrs.defaultUnCheckedHoliday, mAttrs.defaultUnCheckedWorkday, mAttrs.defaultUnCheckedHolidayTextColor, mAttrs.defaultUnCheckedWorkdayTextColor, noAlphaColor);
            }
        }
        drawStretchText(canvas, rectF, noAlphaColor, localDate);
